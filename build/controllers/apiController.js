...
var ApiController = /** @class */ (function () {
    ...
    ApiController.prototype.crearCiclo = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('call insertar_ciclo(?)', [req.body.anio])];
                    case 1:
                        ciclo = _a.sent();
                        res.json(ciclo);
                        return [2 /*return*/];
    ...
    ApiController.prototype.obtenerCiclo = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, ciclo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, database_1.default.query('call obtener_ciclo(?)', [id])];
                    case 1:
                        ciclo = _a.sent();
                        res.json(ciclo);
                        return [2 /*return*/];
    ...
    ApiController.prototype.actualizarCiclo = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var emp, ciclo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        emp = req.body;
                        return [4 /*yield*/, database_1.default.query('call actualizar_ciclo(?, ?)', [emp.ciclo, emp.anio])];
                    case 1:
                        ciclo = _a.sent();
                        res.json(ciclo);
                        return [2 /*return*/];
