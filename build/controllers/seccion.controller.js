...
var SeccionController = /** @class */ (function () {
    ...
    SeccionController.prototype.seccion = function (req, res) {
        res.json({
            text: 'api/seccion'
        });
    };
    SeccionController.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var secciones;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('SELECT * FROM seccion')];
                    case 1:
                        secciones = _a.sent();
                        res.json(secciones);
                        return [2 /*return*/];
    ...
    SeccionController.prototype.getOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, secciones;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SeccionController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
