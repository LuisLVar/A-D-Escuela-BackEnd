...
class ApiController {
  ...
  public async actualizarMateria(req: Request, res: Response) {
    const materia = await pool.query('call actualizar_materia(?, ?, ?)',[req.body.id, req.body.nombre, req.body.contenido]);
    res.json(materia);
  }
  ...
  public async insertarAlumno(req: Request, res: Response) {
    const alumno = await pool.query('call insertar_alumno(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', 
    [req.body.nombre, req.body.apellido, req.body.direccion, req.body.telefono, req.body.cui, req.body.nacionalidad,
      req.body.codigo_personal, req.body.encargado, req.body.fecha_nacimiento, req.body.estado]);        
    res.json(alumno);
  }
  ...
  public async actualizarAlumno(req: Request, res: Response) {
    ...
    [req.body.alumno, req.body.nombre, req.body.apellido, req.body.direccion, req.body.telefono, req.body.cui, req.body.nacionalidad,
      req.body.codigo_personal, req.body.encargado, req.body.fecha_nacimiento, req.body.estado]);
    res.json(alumno);
  }
  ...
  public async insertarPersonal(req: Request, res: Response) {
    const personal = await pool.query('call insertar_personal(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', 
  ...
  public async actualizarPersonal(req: Request, res: Response) {
    ...
    const personal = await pool.query('call actualizar_personal(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', 
